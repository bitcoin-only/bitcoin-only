<template>
	<div id="promote-page">
		...
		<ul class="poster-instructions">
			...
			<li>
				<span>3)</span>Take a photo of the poster and tag
				<a href="https://twitter.com/bitcoinonly_" target="_blank">@bitcoinonly_</a> on twitter
			</li>
		</ul>
...
export default {
	...
	setup() {
		usePageMeta({
			...
			description: 'How to promote Bitcoin Only.',
		})
	},
}
</script>
