<template>
	<div :id="navId" class="side-nav" :class="{ mobile: mobile }">
		<div class="logo">
			<nuxt-link to="/">
		...
		<ul class="main-links" @click="closeMobileNav">
...
export default {
	...
	computed: {
		navId() {
			return this.mobile ? 'side-navigation-mobile' : 'side-navigation'
		},
	},
