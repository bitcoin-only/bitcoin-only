<template>
	<div class="contact-page">
		...
		<ul class="contact-methods">
			...
			<li>
				GitHub Issue -
				<a href="https://github.com/bitcoin-only/bitcoin-only/issues/new/choose" target="_blank"
...
export default {
	...
	setup() {
		usePageMeta({
			...
			description: "Have any questions? Need some help? Contact me and I'll do my best to help",
		})
	},
}
</script>
