<template>
	<div id="wallets-page">
		...
		<p>The wallets listed on this page have explicitly stated that they support Bitcoin only.</p>

		<p>It is very important that you learn how to backup your mnemonic seed & that if you use a passphrase you back that up too. Read <a href="https://github.com/6102bitcoin/FAQ/blob/master/seed.md" target="_blank">this document</a> to learn more about backing up your wallet and check out the <nuxt-link to="/privacy">privacy page</nuxt-link>. See <a href="https://veriphi.io/en/blog/software-wallet-analysis" target="_blank">this report</a> for a comparison of the features of many of the wallets listed below.</p>
